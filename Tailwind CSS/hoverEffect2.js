async function getFakeData() {
  ...
  data.map((val, ind) => {
    if (val.category == "men's clothing") {
      mens.push(val);
    } else if (val.category == "women's clothing") {
      womens.push(val);
  ...
  console.log("========== mens ===========");
  console.log(mens);
  let mensoptionsContainer = document.getElementById("mensoptionsContainer");
  ...
  mens.map(product => {
    ...
    <div class="bg-gray-100">
          <div class="container mx-auto px-4 py-8">
            <div class="flex flex-wrap -mx-4">
              <!-- Product Images -->
              <div class="w-full md:w-1/2 p-4 mb-8">
                <img
                  src="${product.image}"
                  alt="Product"
                  class="w-11/12 p-4 h-auto rounded-lg shadow-md mb-4 bg-white"
                  id="mainImage"
                />
              ...
              <div class="w-full md:w-1/2 px-4">
                ...
                <div class="flex items-center mb-4">
                  ...
                  <span class="ml-2 text-gray-600">${product.rating.rate} (${
    ...
    mensoptionsContainer.append(a);
  });

  console.log("========== womens ===========");
  console.log(womens);

  let womensoptionsContainer = document.getElementById(
    "womensoptionsContainer"
  );
  ...
  womens.map(product => {
    ...
    womensoptionsContainer.append(a);
  });

  console.log("========== jewleries ===========");
  console.log(jewleries);
